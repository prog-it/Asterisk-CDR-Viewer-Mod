...
# ------------------------------------------------------------------------------------------------------------------------------
# Скрипт конвертирования записей звонков из WAV в MP3 и распределения файлов
# по папкам в соответствии с датой.
# 
# Этот скрипт позволяет преобразовать записи звонков из WAV в MP3, а также
# распределить файлы по папкам в соответствии с датой.
#
...
## Уровень вложенности папой для поиска файлов записей звонков при конвертировании -> целое число
